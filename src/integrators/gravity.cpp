...
public:
    ...
    std::pair<Spectrum, Mask> sample(const Scene *scene,
        ...
        // TODO: we probably don't need this or we deal with this at the very end
        ...
        dr::tie(ls) = dr::while_loop(dr::make_tuple(ls),
            ...
            [this, scene, bsdf_ctx](LoopState& ls) {
                // TODO: for now, implement the intersection surface of the bending ray
                ...
                if (dr::any_or<true>(si.emitter(scene) != nullptr)) {
                    ...
                    ls.result = dr::fmadd(
                        ls.throughput,
                        ds.emitter->eval(si, ls.prev_bsdf_pdf > 0.0f) * mis_bsdf,
                        ls.result);
                } else {
                    // If there is an intersection with the sphere, set the value manually
                    ls.result = 0;
                }
        ...
        return {
            dr::select(ls.valid_ray, ls.result, 0.0f),
            ls.valid_ray
        };
    }
